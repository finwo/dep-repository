SRC+={{module.dirname}}/core/src/webview.cc
INCLUDES+=-I{{module.dirname}}/core/include

ifeq ($(OS),Windows_NT)
    # CFLAGS += -D WIN32
    override CFLAGS+=
    override CPPFLAGS+=-I {{module.dirname}}/external/libs/Microsoft.Web.WebView2.1.0.1150.38/build/native/include
